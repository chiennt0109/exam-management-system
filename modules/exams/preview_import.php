...
<div style="display:flex;min-height:calc(100vh - 44px);">
    ...
    <div style="flex:1;padding:20px;min-width:0;">
        <div class="card shadow-sm mb-3"><div class="card-header bg-primary text-white"><strong>Import điểm thi - Bước 2/3: Mapping + Preview</strong></div><div class="card-body">
            ...
            <div class="alert alert-secondary mb-2">Môn: <strong><?= htmlspecialchars($subjectName, ENT_QUOTES, 'UTF-8') ?></strong> | Max điểm: <strong><?= htmlspecialchars((string) $maxScore, ENT_QUOTES, 'UTF-8') ?></strong></div>
            ...
            <form method="post" action="<?= BASE_URL ?>/modules/exams/process_import.php" class="d-flex gap-2 mt-3">
                ...
                <button class="btn btn-danger" type="submit" name="strategy" value="overwrite">Ghi đè</button>
                <button class="btn btn-warning" type="submit" name="strategy" value="skip_existing">Bỏ qua bản ghi đã có</button>
