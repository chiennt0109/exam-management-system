...
if ($export === 'excel') {
    ...
    echo '<Row><Cell ss:MergeAcross="2" ss:StyleID="TH"><Data ss:Type="String">TRƯỜNG THPT CHUYÊN ĐIỆN BIÊN</Data></Cell><Cell ss:Index="4" ss:MergeAcross="' . ($totalCols - 4) . '" ss:MergeDown="1" ss:StyleID="TH"><Data ss:Type="String">BẢNG ĐIỂM</Data></Cell></Row>';
...
if ($export === 'pdf') {
    ...
    echo '<table class="title-table"><tr><td colspan="3" class="center"><strong>TRƯỜNG THPT CHUYÊN ĐIỆN BIÊN</strong></td><td colspan="' . (1 + array_sum(array_map(static fn($s) => count($s['columns']), $subjectColumns))) . '" rowspan="2" class="center"><strong>BẢNG ĐIỂM</strong></td></tr>';
